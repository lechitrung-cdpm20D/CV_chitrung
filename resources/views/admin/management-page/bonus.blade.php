        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('thuong.create') }}"><button type="button" class="btn btn-outline-primary">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($danhSachThuong as $tp)
                                                    <tr>
                                                        <td><?php echo ++$i; ?></td>
                                                        <td>{{ $tp->ma_thuong }}</td>
                                                        <td>{{ number_format($tp->tien_thuong, 0) }} VNĐ</td>
                                                        <td>
                                                            {{-- https://jsfiddle.net/prasun_sultania/KSk42/ hướng dẫn chỉnh lại title --}}
                                                            <a href="{{ route('thuong.edit', ['thuong' => $tp]) }}"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    title="Chỉnh sửa thông tin thưởng"><i
                                                                        class="far fa-edit"></i></button></a>
                                                            <button type="button" class="btn btn-outline-danger"
                                                            onclick="confirm('{{ route('thuong.destroy', ['thuong' => $tp]) }}')"
                        ...
                        <div class="popup">
                            ...
                            <div class="form-popup" style="width: auto">
                                <div class="row-popup">
                                    <h3 style="color:red;text-align: center;">Xóa thưởng</h3>
                                </div>
                                <form method="post" action="#" id="formdelete">
                                    @csrf
                                    @method('DELETE')
                                    <h4 style="display:block">Bạn có muốn xóa thưởng này không
                                        ?</h4>
