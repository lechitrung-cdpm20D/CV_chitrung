        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('heSoLuong.create') }}"><button type="button"
                                    ...
                                    <div class="table-responsive">
                                        <table id="zero_config" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php $i = 0; ?>
                                                @foreach ($danhSachHeSoLuong as $tp)
                                                    <tr>
                                                        <td><?php echo ++$i; ?></td>
                                                        <td>{{ $tp->ma_hsl }}</td>
                                                        <td>{{ $tp->he_so_luong }}</td>
                                                        <td>
                                                            <a href="{{ route('heSoLuong.edit', ['heSoLuong' => $tp]) }}"><button
                                                                    type="button" class="btn btn-outline-secondary"
                                                                    title="Chỉnh sửa thông tin hệ số lương"><i
                                                                        class="far fa-edit"></i></button></a>
                                                            <button type="button" class="btn btn-outline-danger"
                                                                onclick="confirm('{{ route('heSoLuong.destroy', ['heSoLuong' => $tp]) }}')"
                                                                title="Xóa hệ số lương"><i
                        ...
                        <div class="popup">
                            ...
                            <div class="form-popup" style="width: auto">
                                <div class="row-popup">
                                    <h3 style="color:red;text-align: center;">Xóa hệ số lương</h3>
                                </div>
                                <form method="post" action="#" id="formdelete">
                                    @csrf
                                    @method('DELETE')
                                    <h4 style="display:block">Bạn có muốn xóa hệ số lương này không
                                        ?</h4>
