        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('cameraTruoc.create') }}"><button type="button"
                                                ...
                                                @foreach ($danhSachCameraTruoc as $tp)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a
                                                                href="{{ route('cameraTruoc.edit', ['cameraTruoc' => $tp]) }}"><button
                                                                    type="button" class="btn btn-outline-secondary"
                                                                    title="Chỉnh sửa thông tin camera trước"><i
                                                                        class="far fa-edit"></i></button></a>
                                                            <button type="button" class="btn btn-outline-danger"
                                                                onclick="confirm('{{ route('cameraTruoc.destroy', ['cameraTruoc' => $tp]) }}')"
                                                                title="Xóa camera trước"><i
                        ...
                        <div class="popup">
                            ...
                            <div class="form-popup" style="width: auto">
                                <div class="row-popup">
                                    <h3 style="color:red;text-align: center;">Xóa camera trước</h3>
                                </div>
                                <form method="post" action="#" id="formdelete">
                                    @csrf
                                    @method('DELETE')
                                    <h4 style="display:block">Bạn có muốn xóa camera trước này không
                                        ?</h4>
