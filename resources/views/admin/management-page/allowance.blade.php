        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('phuCap.create') }}"><button type="button" class="btn btn-outline-primary">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($danhSachPhuCap as $tp)
                                                    <tr>
                                                        <td><?php echo ++$i; ?></td>
                                                        <td>{{ $tp->ma_phu_cap }}</td>
                                                        <td>{{ number_format($tp->tien_phu_cap, 0) }} VNĐ</td>
                                                        <td>
                                                            <a href="{{ route('phuCap.edit', ['phuCap' => $tp]) }}"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    title="Chỉnh sửa thông tin phụ cấp"><i
                                                                        class="far fa-edit"></i></button></a>
                                                            <button type="button" class="btn btn-outline-danger"
                                                            onclick="confirm('{{ route('phuCap.destroy', ['phuCap' => $tp]) }}')"
                        ...
                        <div class="popup">
                            ...
                            <div class="form-popup" style="width: auto">
                                <div class="row-popup">
                                    <h3 style="color:red;text-align: center;">Xóa phụ cấp</h3>
                                </div>
                                <form method="post" action="#" id="formdelete">
                                    @csrf
                                    @method('DELETE')
                                    <h4 style="display:block">Bạn có muốn xóa phụ cấp này không
                                        ?</h4>
