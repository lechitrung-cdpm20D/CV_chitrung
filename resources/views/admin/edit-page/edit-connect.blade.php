        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Cập nhật kết nối</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('ketNoi.update', ['ketNoi' => $ketNoi]) }}" method="post" accept-charset="utf-8">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="mangdidong" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Mạng di động" value="{{ $ketNoi->mang_di_dong }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="sim" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Sim" value="{{ $ketNoi->sim }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="wifi" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Wifi" value="{{ $ketNoi->wifi }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="gps" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Gps" value="{{ $ketNoi->gps }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="bluetooth" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Bluetooth" value="{{ $ketNoi->bluetooth }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="congketnoi" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Cổng kết nối" value="{{ $ketNoi->cong_ket_noi }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="jacktainghe" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Jack tai nghe" value="{{ $ketNoi->jack_tai_nghe }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="ketnoikhac" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Kết nối khác" value="{{ $ketNoi->ket_noi_khac }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
