        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('loaiTaiKhoan.index') }}">
                                <button type="button" class="btn btn-outline-primary">
                                    <i class="fa fa-list-ul"></i> Quản lý loại tài khoản
                                </button>
                            </a>
                            <hr>
                            <form action="{{ route('loaiTaiKhoan.update', ['loaiTaiKhoan' => $loaiTaiKhoan]) }}" method="post"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="tenloaitaikhoan" type="text"
                                                            style="height: 40px;" id="" placeholder="Tên loại tài khoản"
