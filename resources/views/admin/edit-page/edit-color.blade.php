        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Cập nhật màu</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('mauSac.index') }}">
                                <button type="button" class="btn btn-outline-primary">
                                    <i class="fa fa-list-ul"></i> Quản lý màu
                                </button>
                            </a>
                            <hr>
                            <form action="{{ route('mauSac.update', ['mauSac' => $mauSac]) }}" method="post"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="tenmausac" type="text"
                                                            style="height: 40px;" id="" placeholder="Tên màu"
                                                            value="{{ $mauSac->ten_mau_sac }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
