...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('dienThoai.edit', ['dienThoai' => $dienThoai]) }}"><button type="button"
                                    ...
                                    <hr>
                                    <form
                                        action="{{ route('chiTietDienThoai.update', ['chiTietDienThoai' => $chiTietDienThoai]) }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-camerasau"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-cameratruoc"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-hedieuhanh"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-bonho"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-ketnoi"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-tienich"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-thongtinchung"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-11" style="z-index: 1">
                                                                <select name="mausac"
                                                                    ...
                                                                    @foreach ($danhSachMauSac as $tp)
                                                                        @if ($chiTietDienThoai->mau_sac_id == $tp->id)
                                                                            <option value="{{ $tp->id }}" selected>
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-outline-secondary add-mausac"
                                                                style="width: 40px;">
                                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div>
                                                                <input class="form-control" name="gia" type="number"
                                                                    ...
                                                                    id="product_price" placeholder="0"
                                                                    value="{{ $chiTietDienThoai->gia }}" min='0'
                                                                    required>
                                                                <div
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="text-align: center; margin-top: 20px">
                                                <button type="submit" class="btn btn-primary">Cập nhật chi tiết sản
                                                    phẩm</button>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="popup themcamerasau">
                            ...
                            <div class="form-popup">
                                ...
                                <form action="{{ route('cameraSau.store') }}" enctype="multipart/form-data"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="quayphim" type="text"
                                                                style="height: 40px;" placeholder="Quay phim" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="denflash" type="text"
                                                                style="height: 40px;" placeholder="Đèn flash" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="tinhnang" type="text"
                                                                style="height: 40px;" placeholder="Tính năng" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="popup themcameratruoc">
                            ...
                            <div class="form-popup">
                                ...
                                <form action="{{ route('cameraTruoc.store') }}" enctype="multipart/form-data"
                                    method="post" accept-charset="utf-8">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                        ...
                        <div class="popup themhedieuhanh">
                            ...
                            <div class="form-popup">
                                ...
                                <form action="{{ route('heDieuHanh_CPU.store') }}" enctype="multipart/form-data"
                                    method="post" accept-charset="utf-8">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="hedieuhanh" type="text"
                                                                style="height: 40px;" placeholder="Hệ điều hành" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="chipxuly" type="text"
                                                                style="height: 40px;" placeholder="Chip xử lý" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="tocdocpu" type="text"
                                                                style="height: 40px;" placeholder="Tốc độ cpu" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="chipdohoa" type="text"
                                                                style="height: 40px;" placeholder="Chip đồ họa" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="popup thembonho">
                            ...
                            <div class="form-popup">
                                ...
                                <form action="{{ route('boNho_LuuTru.store') }}" enctype="multipart/form-data"
                                    method="post" accept-charset="utf-8">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="ram" type="text"
                                                                style="height: 40px;" placeholder="Ram" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="bonhotrong" type="text"
                                                                style="height: 40px;" placeholder="Bộ nhớ trong" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="bonhoconlai" type="text"
                                                                style="height: 40px;" placeholder="Bộ nhớ còn lại" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="thenho" type="text"
                                                                style="height: 40px;" placeholder="Thẻ nhớ" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="danhba" type="text"
                                                                style="height: 40px;" placeholder="Danh bạ" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="mangdidong" type="text"
                                                                style="height: 40px;" placeholder="Mạng di động" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="sim" type="text"
                                                                style="height: 40px;" placeholder="Sim" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="wifi" type="text"
                                                                style="height: 40px;" placeholder="Wifi" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="gps" type="text"
                                                                style="height: 40px;" placeholder="Gps" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="bluetooth" type="text"
                                                                style="height: 40px;" placeholder="Bluetooth" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="jacktainghe" type="text"
                                                                style="height: 40px;" placeholder="Jack tai nghe" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="ketnoikhac" type="text"
                                                                style="height: 40px;" placeholder="Kết nối khác" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="dungluongpin" type="text"
                                                                style="height: 40px;" placeholder="Dung lượng pin" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="loaipin" type="text"
                                                                style="height: 40px;" placeholder="Loại pin" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="hotrosactoida" type="text"
                                                                style="height: 40px;" placeholder="Hỗ trợ sạc tối đa"
                                                                value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="sackemtheomay" type="text"
                                                                style="height: 40px;" placeholder="Sạc kèm theo máy"
                                                                value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="congnghepin" type="text"
                                                                style="height: 40px;" placeholder="Công nghệ pin" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="baomatnangcao" type="text"
                                                                style="height: 40px;" placeholder="Bảo mật nâng cao"
                                                                value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-12">Tính năng đặt biệt<span
                                                                style="color:red">*</span></label>
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="tinhnangdacbiet"
                                                                type="text" style="height: 40px;"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="khangnuocbui" type="text"
                                                                style="height: 40px;" placeholder="Kháng nước bụi" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="ghiam" type="text"
                                                                style="height: 40px;" placeholder="Xem phim" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="nghenhac" type="text"
                                                                style="height: 40px;" placeholder="Nghe nhạc" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="popup themthongtinchung">
                            ...
                            <div class="form-popup">
                                ...
                                <form action="{{ route('thongTinChung.store') }}" enctype="multipart/form-data"
                                    method="post" accept-charset="utf-8">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="thietke" type="text"
                                                                style="height: 40px;" placeholder="Thiết kế" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="chatlieu" type="text"
                                                                style="height: 40px;" placeholder="Chất liệu" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-12">Kích thước khối lượng<span
                                                                style="color:red">*</span></label>
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="kichthuockhoiluong"
                                                                type="text" style="height: 40px;"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="thoidiemramat" type="date"
                                                                style="height: 40px;" placeholder="Thời điểm ra mắt"
                                                                value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="tenmausac" type="text"
                                                                style="height: 40px;" placeholder="Tên màu" value=""
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        const btnclosethemthongtinchung = this.document.querySelector(
            '.popup.themthongtinchung .form-popup .row-popup button');
