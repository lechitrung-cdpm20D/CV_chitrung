        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Cập nhật camera trước</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('cameraTruoc.index') }}"">
                                    <button type=" button" class="btn btn-outline-primary">
                                <i class="fa fa-list-ul"></i> Quản lý camera trước
                                </button>
                            </a>
                            <hr>
                            <form action="{{ route('cameraTruoc.update', ['cameraTruoc' => $cameraTruoc]) }}" method="post" accept-charset="utf-8">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="card-title">THÔNG TIN CAMERA TRƯỚC</h4>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="dophangiai" type="text"
                                                            style="height: 40px;" placeholder="Độ phân giải" value="{{ $cameraTruoc->do_phan_giai }}"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="tinhnang" type="text"
                                                            style="height: 40px;" placeholder="Tính năng" value="{{ $cameraTruoc->tinh_nang }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="text-align: center; margin-top:20px">
                                        <button type="submit" class="btn btn-primary">Cập nhật camera trước</button>
                                    </div>
                                </div>
                            </form>
                        </div>
