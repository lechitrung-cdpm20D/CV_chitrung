        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Cập nhật camera sau</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('cameraSau.index') }}">
                                <button type="button" class="btn btn-outline-primary">
                                    <i class="fa fa-list-ul"></i> Quản lý camera sau
                                </button>
                            </a>
                            <hr>
                            <form action="{{ route('cameraSau.update', ['cameraSau' => $cameraSau]) }}" method="post"
                                accept-charset="utf-8">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="card-title">THÔNG TIN CAMERA SAU</h4>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="dophangiai" type="text"
                                                            style="height: 40px;" placeholder="Độ phân giải"
                                                            value="{{ $cameraSau->do_phan_giai }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="quayphim" type="text"
                                                            style="height: 40px;" placeholder="Quay phim"
                                                            value="{{ $cameraSau->quay_phim }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="denflash" type="text"
                                                            style="height: 40px;" placeholder="Đèn flash" value="{{ $cameraSau->den_flash }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="tinhnang" type="text"
                                                            style="height: 40px;" placeholder="Tính năng"
                                                            value="{{ $cameraSau->tinh_nang }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="text-align: center; margin-top:20px">
                                        <button type="submit" class="btn btn-primary">Cập nhật camera sau</button>
                                    </div>
                                </div>
                            </form>
                        </div>
