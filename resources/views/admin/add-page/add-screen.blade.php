        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Thêm màn hình</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('manHinh.store') }}" method="post" accept-charset="utf-8">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="card-title">MÀN HÌNH MỚI</h4>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="dophangiai" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Độ phân giải" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="manhinhrong" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Màn hình rộng" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="dosangtoida" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Độ sáng tối đa" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="matkinhcamung" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Mặt kính cảm ứng" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
