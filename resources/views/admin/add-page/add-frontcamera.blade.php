        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Thêm camera trước</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('cameraTruoc.store') }}" method="post" accept-charset="utf-8">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="card-title">CAMERA TRƯỚC MỚI</h4>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="tinhnang" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Tính năng" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
