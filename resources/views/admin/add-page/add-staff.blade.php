                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('nhanVien.store') }}" method="post" accept-charset="utf-8">
                                @csrf
                                <input type="hidden" name="token"
                                    value='{{Auth::user()->token}}'>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="card-title">NHÂN VIÊN MỚI</h4>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="hoten" type="text"
                                                            style="height: 40px;" placeholder="Họ tên" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="diachi" type="text"
                                                            style="height: 40px;" placeholder="Địa chỉ" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="ngaysinh" type="date"
                                                            style="height: 40px;" placeholder="Ngày sinh" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="sdt" type="text"
                                                            style="height: 40px;" placeholder="SĐT" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="cccd" type="text"
                                                            style="height: 40px;" placeholder="CCCD" value="" required
                                                            max="12">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="bhxh" type="text"
                                                            style="height: 40px;" placeholder="BHXH" value="" required
                                                            max="10">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-11" style="z-index: 1">
                                                        <select name="taikhoan"
                                                            ...
                                                            @foreach ($danhSachTaiKhoan as $tp)
                                                                <option value="{{ $tp->id }}">{{ $tp->username }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
