        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('phuCap.index') }}">
                                <button type="button" class="btn btn-outline-primary">
                                    <i class="fa fa-list-ul"></i> Quản lý phụ cấp
                                </button>
                            </a>
                            <hr>
                            <form action="{{ route('phuCap.store') }}" method="post" accept-charset="utf-8">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="maphucap" type="text"
                                                            style="height: 40px;" placeholder="Mã phụ cấp" value=""
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-12">Tiền phụ cấp<span
                                                            style="color:red">*</span></label>
                                                    <div>
                                                        <input class="form-control" name="tienphucap" type="number"
